...
function StoryProblems({ difficulty, onBack }) {
  ...
  useEffect(() => {
    // Generate new story problems when component mounts or difficulty changes
    setQuestions(generateQuestionBatch('story', difficulty, 10))
    setCurrentIndex(0)
    setScore(0)
    setIsComplete(false)
  }, [difficulty])
  ...
  return (
    <div className="story-section">
      ...
      {/* Operation hint */}
      <div className="chalk-text" style={{ textAlign: 'center', marginBottom: '10px', opacity: 0.7 }}>
        {currentQuestion.operation === 'addition' ? '(Adding)' : '(Taking Away)'}
      </div>
